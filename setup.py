...
setuptools.setup(
  ...
  version = '0.5.8',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/codeclinic/TuyaPower2MQTT/archive/0.5.8.tar.gz',    # I explain this later on
